...
- Developed a billing admin panel using React.js with reusable components and responsive design
- Designed mobile billing app UI in Figma following Material Design 2 guidelines with full user flow prototyping

### Backend & Android Intern | Werkz Technologies | Yangon, Myanmar
**Oct 2020 - Dec 2020 | Internship**

- Built a RESTful note-taking API with Node.js, Express.js, and MongoDB; documented with Swagger and tested with Jest
- Migrated an Android class-scheduling app (Classwerkz) from Java to Kotlin, implementing UI screens and improving app structure
...
- **2x 19th Place, ICPC** — International Collegiate Programming Contest, 2017 & 2018
- **2x 3rd Prize, MCPC** — Myanmar Collegiate Programming Contest, 2018 & 2019
- **2nd Place Qualifier** — Samsung Tech Institute: Mobile App Training, 2017
- **TFSCALE Participant** — Temasek Foundation Specialists' Exchange, Singapore & Myanmar, 2019
